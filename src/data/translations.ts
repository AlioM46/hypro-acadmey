export const translations = {
  ...
  // Hero Section
  logoSubtitle: { en: 'Modern Automotive Academy', ar: 'أكاديمية صيانة السيارات الحديثة' },
  heroBadge: { en: 'HYBRID & ELECTRIC ACADEMY', ar: 'أكاديمية هايبـرو المعتمدة' },
  heroBadge2: { en: '4-Month Intensive Diploma', ar: 'دبلوم مهني مكثّف خلال 4 أشهر' },
  heroTitlePart1: { en: 'Practical Hands-on', ar: 'صيانة عملية حقيقية بنسبة' },
  heroTitlePart2: { en: 'Automotive Career Training', ar: '80%, ومستقبل مهني مضمون في إدلب' },
  heroSubtitle: {
    en: 'No boring theory. Work on modern fuel injection, Toyota/Hyundai hybrids, and pure electric high-voltage loops under 20+ year master mechanics in Idleb. Structured job placement pathways with local workshops and employers.',
    ar: 'ابتعد عن التلقين التقليدي. تدرب بيدك في إدلب على أنظمة حقن البنزين الحديثة، صيانة وتبريد بطاريات الهايبرد لسيارات تويوتا وهيونداي بنسبة 80%، بإشراف مهندسين ذوي خبرة تزيد عن 20 عاماً، مع ربط مباشر للتوظيف والتشغيل.'
  },
  ...
  trainingHubDirectives: { en: 'IDLEB TRAINING HUB DIRECTIVES', ar: 'بروتوكول التأهيل العملي في إدلب' },
  practicalDiagnostics: { en: 'Practical Diagnostics', ar: 'معايرة وفحص حقيقي في إدلب' },
  ...
  // B2B & Alliances
  b2bTag: { en: 'B2B & INSTITUTIONAL ALLIANCES', ar: 'بوابة الشراكات والتشبيك المهني للمؤسسات في إدلب' },
  ...
  aboutTitle: { en: 'About Hypro Academy', ar: 'أكاديمية هايبـرو في الشمال السوري (إدلب)' },
  aboutDesc: {
    en: 'The premier academy in Idleb providing 100% practical high-voltage and hybrid diagnostic education.',
    ar: 'المركز المتكامل الأول بإدلب لتخريج وتأهيل مصلحي سيارات الفولت الهجين، والكهرباء الكاملة، والكمبيوتر العملي.'
  },
  ...
  certifiedIdlebOffice: { en: 'Certified Idleb Office', ar: 'مقر إدلب النشط' },
  ...
  // Mentors
  ourEliteMentors: { en: 'OUR ELITE MENTORS', ar: 'الكادر الفني والهندسي للمركز في إدلب' },
  ...
  contactPrompt: {
    ...
    ar: 'تواصل بنقرة واحدة مع منسق القبول الخارجي عبر القنوات المباشرة، أو تفضل بزيارة مقر الأكاديمية في إدلب.'
  },
  ...
  campusBase: { en: 'CAMPUS BASE', ar: 'موقع الأكاديمية بإدلب' },
  ...
  searchPlaceholder: { en: 'Search FAQs (e.g., experience, certificate)...', ar: 'ابحث في الأسئلة (مثال: شهادة، خبرة، إدلب)...' },
