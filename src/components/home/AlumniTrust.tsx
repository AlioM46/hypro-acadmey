          ...
          <div className="bg-white border border-slate-200 p-8 flex flex-col justify-between">
            <div>
              ...
              <p className="text-slate-800 text-xs sm:text-sm leading-relaxed font-medium font-sans italic">
                {lang === 'en'
                  ? '"I was a traditional mechanic doing simple oil changes. After 300+ hours of training at Hypro, I opened my own hybrid battery diagnostics center in Syria. I earn three times more now."'
                  : '"كنت أعمل كميكانيكي تقليدي وبأجور بسيطة. بعد إتمام دبلوم تدريبي مهني من 300+ ساعة في هايبـرو، افتتحت مركزي الخاص لصيانة بطاريات الهايبرد في المنطقة الصناعية، وتضاعف دخلي ٣ مرات."'}
              </p>
            </div>
